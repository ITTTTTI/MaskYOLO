...
class Annotator:
    ...
    def text(self, xy, text, txt_color=(255, 255, 255)):
        ...
        w, h = self.font.getbbox(text)  # text width, height
...
def plot_labels(labels, names=(), save_dir=Path('')):
    ...
    a1=ax[0].set_title('(a)',y=-0.2, fontsize=12)
    a2=ax[1].set_title('(b)',y=-0.2, fontsize=12)
    a3=ax[2].set_title('(a)',y=-0.2,fontsize=12)
    a4=ax[3].set_title('(b)',y=-0.2, fontsize=12)
    '''a1.set_position([0.5, 1])
    a2.set_position([0.5, 1])
    a3.set_position([0.5, 1])
    a4.set_position([0.5, 1])'''
